            ...
            <div className="item-link-container flex flex-row items-center gap-2 text-light-constant">
                <a className="item-link font-primary font-medium text-base flex flex-row gap-2" href={props.item.linkUrl}>
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.75 12H20.25" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin ="round"/>
                        <path d="M13.5 5.25L20.25 12L13.5 18.75" stroke="#FFFFFF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin ="round"/>
                    </svg>
                </a>
            </div>
      </div>
