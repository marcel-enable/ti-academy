...
export default function CurrentUserNavBar() {
  ...
  return (
    <nav className="w-full bg-white shadow py-4">
      <div className="justify-between px-12 sm:px-16 md:px-20 md:items-center md:flex">
        <div>
        ...
        <div className={`flex ml-8 my-auto space-x-6 md:block ${navbar ? 'block' : 'hidden'}`}>
          <ul className="items-center justify-between space-y-3 md:space-y-0 md:flex md:space-x-6 w-full">
            <li className="md:hover:bg-white hover:bg-slate-100 rounded pl-2 py-1.5 font-primary">
              <a href="/">Academy</a>
            </li>
            <li className="md:hover:bg-white hover:bg-slate-100 rounded pl-2 py-2 font-primary">
              <a href="/help">Help</a>
            </li>
            <li className="md:hover:bg-white hover:bg-slate-100 rounded pl-2 py-2 font-primary">
